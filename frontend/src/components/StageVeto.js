...
function ShowStage(props) {
    ...
    async function handleClick(event) {
        ...
        props.stage.isApprouve = event.target.name;
    ...
    return (
        <>
            ...
            <td className={props.stage.isApprouve}>{props.stage.isApprouve}</td>
            ...
            >
                ...
                <Modal.Body className="show-grid">
                    <Container>
                        ...
                        <Row>
                            <Col className={props.stage.isApprouve}>{props.stage.isApprouve}</Col>
                        </Row>
                ...
                <Modal.Footer>
                    <Button type="button" className="btnVeto" name={approuved}
                            disabled={props.stage.isApprouve === approuved} value={props.stage.id} onClick={handleClick}
                            variant="success">Oui</Button>
                    <Button type="button" className="btnVeto" name={denied} disabled={props.stage.isApprouve === denied}
